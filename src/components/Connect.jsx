...
import { emailAddress, fbmUrl, ghUrl, igUrl, liUrl, phoneNumber } from '../constants';
...
const Connect = () => {
  ...
  return (
    <div id='connect' className='h-screen flex flex-col justify-center items-center'>
      ...
      <div className='flex flex-wrap justify-center items-center mt-30 gap-10 mx-10 mb-30'>
        ...
        <button onClick={ScrollToTop} className='pt-20 absolute bottom-15 lg:bottom-20 flex flex-col items-center justify-center group transition-all duration-300'>
          <i className="fa fa-angle-double-up fa-xl transition-all group-hover:-translate-y-2" aria-hidden="true"></i>
          <h2 className='hove mt-3 text-center text-sm font-clash font-regular'>Make your way up.</h2>
        </button>
      </div>
    </div>
  )
